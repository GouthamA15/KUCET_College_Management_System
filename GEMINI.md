...
- **E2E Classification (No App Code Changed):** All fixes were isolated to the three test spec files. The app source code (`src/`) is untouched — 100% of unit tests (116/116) and E2E tests (16/16) are passing cleanly.
