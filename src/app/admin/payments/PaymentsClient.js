          ...
          <div className="flex flex-col lg:flex-row gap-4 items-end">
            <div className="flex-1 w-full">
              ...
              <form onSubmit={handleSearch} className="flex gap-2">
                ...
                />
                <button type="submit" className="bg-[#0b3578] text-white px-4 py-2 rounded text-xs font-bold uppercase tracking-widest hover:bg-[#0a2d66] transition-colors cursor-pointer">Search</button>
              </form>
            </div>
            ...
            <div className="w-full lg:w-48">
              ...
              <select 
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded text-sm focus:ring-1 focus:ring-blue-500 outline-none bg-white cursor-pointer"
              >
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-end">
            ...
            { (startDate || endDate) && (
              <button 
                ...
                className="px-4 py-2 border border-slate-200 rounded text-xs font-bold text-slate-600 uppercase tracking-widest hover:bg-slate-50 transition-colors cursor-pointer"
              >
                Clear Dates
              </button>
            )}
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-lg border border-slate-200 shadow-2xl rounded-sm overflow-hidden flex flex-col">
                <div className="bg-[#0b3578] p-4 flex justify-between items-center">
                    ...
                    <button onClick={() => setIsDetailsOpen(false)} className="text-white/60 hover:text-white transition-colors cursor-pointer">
