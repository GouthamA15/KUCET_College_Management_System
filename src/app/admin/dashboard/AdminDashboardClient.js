      ...
      <div className="w-full max-w-6xl mx-auto bg-white border border-slate-200 shadow-sm p-4 sm:p-6 lg:p-8 flex flex-col items-center">
        ...
        <div className="w-full flex border-b mb-6">
          <button
            ...
            className={`px-6 py-2 font-semibold transition uppercase text-xs tracking-widest cursor-pointer ${activeTab === 'stats' ? 'text-[#0b3578] border-b-2 border-[#0b3578]' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Overview & Stats
          </button>
          <button
            onClick={() => setActiveTab('faculty')}
            className={`px-6 py-2 font-semibold transition uppercase text-xs tracking-widest cursor-pointer ${activeTab === 'faculty' ? 'text-[#0b3578] border-b-2 border-[#0b3578]' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Faculty Management
          </button>
        </div>
