...
function ScholarshipDashboardContent() {
  ...
  const _openProfile = () => {
    try {
      router.push('/staff/scholarship/profile');
    } catch {
      // ignore
    }
  };
          ...
          <section id="search-section" className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <div className="lg:col-span-7">
                <Link href="/staff/scholarship/student-records" className="block h-full cursor-pointer hover:-translate-y-1 transition-transform group">
