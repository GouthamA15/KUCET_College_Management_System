...
import AttendanceHistoryViewer from '@/components/staff/faculty/AttendanceHistoryViewer';
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-gray-500 font-medium">Loading attendance history...</p>
      </div>
    );
  }
