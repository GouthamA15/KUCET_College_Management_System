...
function QuizPlayInner() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[350px] p-6">
        ...
        <p className="text-xs text-gray-500 mt-1">Synchronizing server timer and question bank</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[350px] p-6">
        <div className="max-w-md w-full bg-white p-6 rounded-sm border border-gray-300 shadow-sm text-center space-y-4">
...
export default function QuizPlayPage() {
  return (
    <EventGuard eventKey="quiz">
      <Suspense
        fallback={
          <div className="flex items-center justify-center min-h-[350px] p-6">
