  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center">
        <Image onError={(e) => { e.currentTarget.style.display = 'none'; }} src={getAssetUrl('/assets/ku-logo.png')} alt="KUCET logo" width={160} height={160} className="w-40 h-auto mx-auto" priority />
