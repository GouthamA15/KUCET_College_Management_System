...
export default function StudentRequestsPage() {
  ...
  if (isLoading || loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] p-6 text-slate-500 font-bold uppercase tracking-widest text-xs">
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-8 font-sans text-slate-900">
