export const semester5 = [
  {
    ...
    "units": [
      { "name": "UNIT – I Introduction & Data Modeling", "topics": ["Introduction to Database System and its Applications: Evolution of DBMS, File Systems versus a DBMS, Data Models, Levels of Abstraction in a DBMS, Data Independence, Structure of a DBMS.", "Data modeling: Introduction to ER model, Naming, conventions, Entities, Attributes, and Entity Sets, Relationships and Relationship Types, Constraints."] },
  ...
  },
  {
    ...
    "variants": [
      ...
      },
      {
        ...
        "units": [
          { "name": "UNIT I .NET Framework", "topics": ["Programming Models: Introduction to .NET Framework – Evolution of .NET technologies - CTS, CLS, CLR, MSIL, JIT, Assemblies, .NET Security Model – Introduction to Base Class Library", "Introduction to VB.NET: Working with Visual Studio IDE – IDE Components –Environment Options VB.NET Fundamentals – Variables – Data Types – Arrays – Control Flow Statements – Modular Coding – Subroutines – Functions – Argument-Passing"] },
          { "name": "UNIT II Classes & Interfaces", "topics": ["Classes: Instance Fields – Constructors – Properties – Methods – Object – Inheritance – Static Classes – Interfaces", "Exception Handling: Need – Models – Statements – Creating Exception Classes", "Collections: Arrays – ArrayList Collection – HashTable Collection – SortedList Class – IEnumerator and IComparer Interfaces", "File Handling: Handling Strings, Characters and Dates – File Class - Directory Class – Accessing Files – FileStream– StreamWriter– StreamReader– BinaryWriter- Binary Reader"] },
          { "name": "UNIT III Windows Forms", "topics": ["Windows Forms: Form Properties – Form Events - Building Dynamic Forms at Runtime", "Introduction to Components and controls: Adding Components and controls to forms – Layout and Grouping – Responding to User Inputs – Mouse and Keyboard Events – Designing Menus – Building MDI Applications- Reading Input through Controls – Presentation and Information Controls – Common Dialog Controls – RichTextBox Control - Creating Windows Installer."] },
          { "name": "UNIT IV ADO.NET", "topics": ["ADO.NET Architecture: DataSet – DataGrid Control- Data Binding – DataAdapter – Command Objects – DataReader - Performing Updates", "Introduction to Web Programming: Building Web Applications – Web Controls - Interacting with Web Applications – Maintaining State – ASP.NET Objects – Page Object – Response Object – Request Object – Server Object – Deploying ASP.NET Applications."] },
          { "name": "UNIT V Data Binding & Web Services", "topics": ["Data-Bound Web Controls: Simple Data binding – Binding to DataSets – Customizing dataGrid Control", "Building and Consuming Web Services: ASP.NET Web Service Projects", "Theoretical Introduction to C# and its Comparison with VB"] }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    "variants": [
      ...
      {
        "code": "PE3112CS",
        "title": "Dotnet Technologies Lab",
        "units": [
          { "name": "Experiments", "topics": ["1. Familiarization with IDE", "2. Programming Console applications using VB.NET covering all aspects of VB.NET fundamentals", "3. Object oriented programming using VB.NET covering objects, Inheritance, Polymorphism, Constructors, Static Classes and Interfaces", "4. Programs to implement Exception Handling concepts", "5. Programs to implement use of Collections", "6. Programs to perform File I/O Operations", "7. Programming Windows applications using VB.NET covering all major controls and components, Menus, MDI, Event Handling", "8. Creating windows installer", "9. Programs to interact with Database from a Windows Desktop Application", "10. Programming to Build web applications using web controls, maintaining state", "11. Deploying ASP.NET web application", "12. Programs to interact with Database from a Web Application using appropriate controls", "13. Programs to create and consume a Web Service"] }
        ]
      }
    ]
  }
