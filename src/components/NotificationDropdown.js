...
export default function NotificationDropdown({ onOpenChange }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {notifOpen && (
        <div className="absolute left-0 lg:left-full lg:ml-4 mt-3 lg:-mt-2 w-[calc(100vw-2rem)] sm:w-80 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden z-[100] animate-fadeIn">
