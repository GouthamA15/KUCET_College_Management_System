  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-100 p-4 sm:p-6 lg:p-8 flex flex-col">
        <div className="w-full flex-1 flex flex-col md:overflow-hidden">
          <div className="max-w-[1000px] mx-auto w-full bg-white rounded-md shadow-sm p-6">
            <h1 className="text-3xl font-bold text-[#0b2447] mb-4">{title}</h1>
            {/* Zones container */}
            <div className="flex-1 flex flex-col md:overflow-hidden space-y-6">
