  ...
  return (
    <section className="relative w-full">
      ...
      <div className="relative w-full h-[300px] md:h-[400px] lg:h-[500px] overflow-hidden">
        ...
        {/* Overlay Text with gray transparent background */}
        <div className={`absolute bottom-0 left-0 right-0 p-6 md:p-10 transition-all duration-700 ease-out ${
          imageLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
        }`}>
          <div className="inline-block bg-gray-900/60 backdrop-blur-sm rounded-lg px-6 py-4 md:px-8 md:py-5">
