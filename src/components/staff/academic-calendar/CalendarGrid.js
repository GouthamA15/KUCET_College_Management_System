...
const CalendarGrid = ({ academicYear, semester }) => {
    ...
    const fetchCalendarData = useCallback(async () => {
        ...
        try {
            ...
            const calendarRes = await fetch(`/api/staff/academic-calendar?academic_year=${academicYear}&semester=${semester}&month=${currentMonth}&year=${currentYear}`);
            ...
            const semesterRes = await fetch(`/api/staff/semesters?academic_year=${academicYear}&semester=${semester}`);
