...
DatePickerInput.displayName = 'DatePickerInput';
      ...
      export default function ClerkStudentManagement() {
        ...
        const [basic, setBasic] = useState({ admission_no:'', roll_no:'', name:'', date_of_birth:'', gender:'Male', course:'CSE', admission_type:'', mobile:'+91', email:'' });
        ...
        const addRequiredFilled = () => {
          return basic.admission_no.trim() && basic.roll_no.trim() && basic.name.trim() && basic.date_of_birth && basic.gender && basic.course && basic.admission_type && basic.mobile.trim() && basic.email.trim();
        };
        ...
        const handleAddStudent = async (e) => {
          ...
          try{
            const payload = {
              ...
              course: basic.course || null,
              admission_type: basic.admission_type || null,
            ...
            try { window.scrollTo({ top: 0, behavior: 'smooth' }); } catch (e) {}
            setBasic({ admission_no:'', roll_no:'', name:'', date_of_birth:'', gender:'Male', course:'CSE', mobile:'+91', email:'' , admission_type: ''});
        ...
        const handleSaveEdits = async () => {
          ...
          try{
            ...
            fetchedStudent.course = editValues.course || fetchedStudent.course;
              ...
              <form onSubmit={handleAddStudent} className="space-y-6">
                <div>
                  <h3 className="font-bold">Section A: Basic Details</h3>
                    ...
                    <div>
                      <select value={basic.admission_type} onChange={e=>setBasic({...basic, admission_type:e.target.value})} className="p-2 border rounded">
                        <option value="">Select Admission Type</option>
                        <option value="Regular">Regular</option>
                        <option value="Lateral">Lateral</option>
                      </select>
                      {!basic.admission_type && <div className="text-xs text-red-600 mt-1">Admission Type is required</div>}
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="md:col-span-2 bg-white p-4 rounded shadow">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                          ...
                          <select value={editValues.course || ''} onChange={e=>setEditValues({...editValues, course:e.target.value})} className="p-2 border rounded">
                            {courses.map(c=> <option key={c} value={c}>{c}</option>)}
                          </select>
                          <div className="relative">
                    ...
                    <div className="bg-white p-4 rounded shadow">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <input placeholder="Year of Study" type="number" min={1} value={(academicsList[0] && academicsList[0].year) || ''} onChange={e=>{ const copy=[...academicsList]; copy[0] = {...(copy[0]||{}), year: e.target.value}; setAcademicsList(copy); }} className="p-2 border rounded" />
