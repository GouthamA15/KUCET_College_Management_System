...
export default function AboutSection() {
  ...
  const aboutParagraphTwo = `Located in the historic city of ${config.location}, Telangana, ${config.shortName} offers undergraduate and postgraduate programs in various engineering disciplines including Computer Science, Electronics and Communication, Mechanical, Civil, and Electrical Engineering. The institution is recognized for its state-of-the-art infrastructure, well-equipped laboratories, experienced faculty, and vibrant campus life. With admission codes ${config.entranceCodes.tgeapcet} for TG EAPCET, ${config.entranceCodes.tgpgecet} for PGECET, and ${config.entranceCodes.tgecet} for TG ECET, the college attracts talented students from across the state.`;
