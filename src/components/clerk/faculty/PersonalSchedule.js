    ...
    <>
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="bg-[#0b3578] p-6 text-white flex justify-between items-center">
          <div>
            <h2 className="text-xl font-black tracking-tight uppercase">My Weekly Teaching Schedule</h2>
            <p className="text-blue-200 text-[10px] font-bold uppercase tracking-widest mt-1 tracking-tighter">Academic Year 2025-26 (System Sync)</p>
          </div>
